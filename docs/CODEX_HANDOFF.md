...
- `battle`: simplified battleship combat controls. W/S thrust and brake, A/D turn, mouse camera, LMB main cannon, RMB secondary, Space missile, Tab target, Shift boost, R recenter.
